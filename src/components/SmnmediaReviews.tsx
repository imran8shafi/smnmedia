...
/* ------------------------------------------------------------------ */
const TestimonialVideo = forwardRef(
  (
    {
      src,
      poster,
    ...
    const defaultVideoStyle = { borderRadius: 12 };
    ...
    return (
      ...
      >
        <video
          ...
          style={{ ...defaultVideoStyle, ...videoStyle }}
        />
...
const TestimonialText = ({
  ...
  return (
    <p className={className} style={{ ...defaultStyle, ...style }}>
      {text}{" "}
      {highlight && (
...
const TestimonialAuthor = ({
  ...
  const defaultNameStyle = { fontFamily: "Hanken Grotesk, sans-serif" };
  const defaultClinicStyle = { fontFamily: "Hanken Grotesk, sans-serif" };
      ...
      <div>
        <div className="flex items-center gap-1">
          <span
            ...
            style={{ ...defaultNameStyle, ...nameStyle }}
          >
            {name}
          </span>
        ...
        {clinic && (
          <p
            ...
            style={{ ...defaultClinicStyle, ...clinicStyle }}
          >
            {clinic}
          </p>
        )}
...
const TestimonialContent = ({
  ...
  const defaultStyle = { minHeight: 140 };
...
const TestimonialCard = ({
  ...
  const defaultStyle = { width: 380, borderRadius: 12 };
